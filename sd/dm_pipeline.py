...
def generate(
    ...
    # clip = models["clip"] # replace with angle embedding generator
    # clip.to(device)
    ...
    context = torch.rand(Batch_Size,Seq_Len,Dim)
    ...
    if input_image:
        ...
        # Images should be between (-1,1), add this in the dataloader/or here
